        ...
        questions: [
          {
            ...
            type: 'single_choice',
            options: [
              { label: 'Sleep better', value: 'sleep_better', icon: '😴' },
              { label: 'Sleep on time', value: 'sleep_on_time', icon: '🌙' },
              { label: 'Wake up on time', value: 'wake_up_on_time', icon: '🌅' },
              { label: 'Sleep and wakeup on time (overall)', value: 'sleep_and_wake_on_time', icon: '⏰' },
            ],
          },
        ],
      },
