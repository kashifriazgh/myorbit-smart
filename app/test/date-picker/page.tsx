...
const DailyGoalsCard: React.FC = () => {
  return (
    <div className="w-full max-w-sm mx-auto bg-slate-50 rounded-3xl overflow-hidden shadow-lg">
      {/* TOP GRADIENT SECTION */}
      <div className="relative bg-gradient-to-b from-blue-900 to-blue-800 px-6 pt-6 pb-14 text-white">
      ...
      <div className="relative -mt-10 px-5 pb-6 space-y-5">
        ...
        <div className="bg-white rounded-2xl p-4 shadow-md">
          <div className="flex justify-between items-start">
            ...
            <div className="w-11 h-11 rounded-xl bg-blue-600 flex items-center justify-center text-white text-lg">
              👣
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm flex items-center justify-between">
          ...
          <button className="text-xs font-semibold px-4 py-1.5 rounded-full bg-blue-900 text-white">
